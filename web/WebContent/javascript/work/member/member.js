	...
	function idcheck() {
		...
		if(id.value == ""){
			...
			window.open(ref,"idcheck.jsp","idcheck","width=300,height=200");
		}
	}
	...
	function check() {
		...
		if(into.value.length > 100){
			alert("자기 소개는 100자 까지 입력 하세요.")
			intro.focus();
			return false;
