...
public class MemberInput {	//메인 클래스

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		// 객체 배열 : 객체의 주소를 배열
		MemberInfo[] m = new MemberInfo[5];	//5명의 정보를 입력 가능하다
		int i = 0;
		String yn;
		...
		do {						
			...
			email = sc.nextLine();	// next는 띄어쓰기가 짤려 버린다. nxetLine은 가능하다		
			System.out.print("주소를 입력하세요? ");
			address = sc.nextLine();		
	
			m[i] = new MemberInfo(name, age, email, address);
			// m.name="홍길동";	//접근제어자가 private으로 되어있어서 접근불가
			i++;
...
class MemberInfo {	//팔드
	private String name;	// private그대로 사용
	private int age;
