...
class TestClass02 {
	...
	public void setValue(Object value) {
		member = value;		// Object value = 3; 오토박싱 & 업캐스팅
	}
...
class GenericTest02 {
	public static void main(String[] args) {
		...
		int n01 = ((Integer)(obj01.getValue())).intValue();	// 다운 캐스팅 + 언박싱
		int n02 = (Integer)(obj01.getValue()); 				// 다운 캐스팅 + 오토 언박싱
		...
		double n03 = ((Double)(obj01.getValue())).doubleValue();	// 다운 캐스팅 + 언박싱
