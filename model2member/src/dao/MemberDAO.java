...
public class MemberDAO {
	...
	public int insert(MemberDTO member) {
		...
		try {
			...
			String sql="insert into member0923 ";
              sql+=" values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,sysdate)";
	...
	public int idcheck(String id) {
		...
		try {
			...
			String sql = "select * from member0923 where id = ?";
...
String sql="select * from member0923 where id=? and passwd=?";
...
String sql="update member0923 set name=?,jumin1=?,jumin2=?,";
       sql+="mailid=?,domain=?,tel1=?,tel2=?,tel3=?,phone1=?,";
       sql+="phone2=?,phone3=?,post=?,address=?,gender=?,";
       sql+="hobby=?,intro=? where id=?";
	...
	public int delete(String id) {
		...
		try {
			...
			String sql = "delete from member0923 where id=?";
